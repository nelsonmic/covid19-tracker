...
$('document').ready(function(){
  ...
  AOS.init({
    ...
    debounceDelay: 49, // the delay on debounce used while resizing window (advanced)
    throttleDelay: 98, // the delay on throttle used while scrolling the page (advanced)
    
  
    // Settings that can be overridden on per-element basis, by `data-aos-*` attributes:
    offset: 119, // offset (in px) from the original trigger point
